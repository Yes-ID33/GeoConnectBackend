...
namespace Services.Migrations
{
    ...
    [Migration("20260508003928_RenameGooglePlaceToNominatim")]
    partial class RenameGooglePlaceToNominatim
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Lugar", b =>
                {
                    ...
                    b.Property<string>("NominatimId")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)")
                        .HasColumnName("NominatimId");

                    b.HasKey("IdLugar");

                    b.HasIndex("IdMunicipio");

                    b.HasIndex("NominatimId")
                        .IsUnique()
                        .HasFilter("[NominatimId] IS NOT NULL");
